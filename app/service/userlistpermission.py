...
async def user_has_access_to_list(user_id: int, list_id: int, session: db.DBSessionDep) -> bool:
...
async def grant_access_to_list(user_id: int, list_id: int, session: db.DBSessionDep) -> dict:
...
async def revoke_access_to_list(user_id: int, list_id: int, session: db.DBSessionDep) -> dict:
